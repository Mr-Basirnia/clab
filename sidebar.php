<div class="col-lg-4">
    ...
    <div class="blog-widget mb-4">
        <div class="card border-0 mb-md-0 mb-3">
            <img class="card-img-top" src="<?= CLAB__URL ?>assets/img/blog/blog-author.jpg" alt="card image">
    ...
    <div class="blog-widget mb-4">
        ...
        <div class="card border-0 mb-1">
            <div class="card-body row align-items-center">
                <div class="col-4">
                    <a href="#"><img class="card-img" src="<?= CLAB__URL ?>assets/img/blog/bt-1.jpg" alt=""></a>
                </div>
                <div class="col-8">
        ...
        <div class="card border-0 mb-1">
            <div class="card-body row align-items-center">
                <div class="col-4">
                    <a href="#"><img class="card-img" src="<?= CLAB__URL ?>assets/img/blog/bt-2.jpg" alt=""></a>
                </div>
                <div class="col-8">
        ...
        <div class="card border-0 mb-1">
            <div class="card-body row align-items-center">
                <div class="col-4">
                    <a href="#"><img class="card-img" src="<?= CLAB__URL ?>assets/img/blog/bt-3.jpg" alt=""></a>
                </div>
                <div class="col-8">
