            ...
            <div class="col-12">
                ...
                <div class="navbar-brand float-left">
                    <a class="" href="index-2.html">
                        <img class="logo-light" src="<?= CLAB__URL ?>assets/img/logo.png"
                             srcset="<?= CLAB__URL ?>assets/img/logo@2x.png 2x" alt="CLab">
                        <img class="logo-dark" src="<?= CLAB__URL ?>assets/img/logo-dark.png"
                             srcset="<?= CLAB__URL ?>assets/img/logo-dark@2x.png 2x"
                             alt="CLab">
                    </a>
                </div>
                <!--brand end-->
                ...
                <nav id="vl-menu">
                    ...
                    <ul class="vlmenu light-sub-menu slide-effect float-right fade-effect">
                        <li><a href="#">خانه <i class="fa fa-angle-down"></i><i class="arrow fa fa-angle-right"></i></a>
                            <!--mega menu start-->
                            <div class="mega-menu half-nav">
                                ...
                                <div class="col3">
                                    ...
                                    <a href="page-landing.html" class="btn btn-sm btn-theme ml-3 mt-2">مشاهده همه دمو
                                        ها</a>
                                </div>
                            </div>
                            <!--mega menu end-->
                        </li>
                        <li><a href="#"> صفحات <i class="fa fa-angle-down"></i><i
                                        class="arrow fa fa-angle-right"></i></a>
                            <!--start level 2-->
                            <ul>
                                <li>
                        ...
                        <li><a href="#">بلاگ <i class="fa fa-angle-down"></i><i class="arrow fa fa-angle-right"></i></a>
                            <!--start level 2-->
                            <ul>
                                <li><a href="#">پوسته وبلاگ<i class="arrow fa fa-angle-right"></i></a>
                                    <!--start level 3-->
                                    <ul>
                                ...
                                <li><a href="#">پست تک <i class="arrow fa fa-angle-right"></i></a>
                                    <!--start level 3-->
                                    <ul>
                        ...
                        <li><a href="#">اجزاء <i class="fa fa-angle-down"></i><i
                                        class="arrow fa fa-angle-right"></i></a>
                            <!--mega menu start-->
                            <div class="mega-menu full-nav">
                                ...
                                <div class="col5">
                                    <!--<h3>Icons</h3>-->
                                    <ol>
                                        <li><a href="component-twitter.html">توییتر <span
                                                        class="badge badge-pill badge-success text-white d-inline-block ml-2 py-1 px-2">زنده</span></a>
                                        </li>
                        ...
                        <li class="menu-right"><a href="#">نمونه کار <i class="fa fa-angle-down"></i><i
                                        class="arrow fa fa-angle-right"></i></a>
                            <!--start level 2-->
                            <ul>
                                <li><a href="#">شبکه<i class="arrow fa fa-angle-right"></i></a>
                                    <!--start level 3-->
                                    <ul>
                                ...
                                <li><a href="#">شبکه کامل عرض<i class="arrow fa fa-angle-right"></i></a>
                                    <!--start level 3-->
                                    <ul>
                                ...
                                <li><a href="#">عنوان شبکه<i class="arrow fa fa-angle-right"></i></a>
                                    <!--start level 3-->
                                    <ul>
                                ...
                                <li><a href="#">ساختمانی<i class="arrow fa fa-angle-right"></i></a>
                                    <!--start level 3-->
                                    <ul>
                                ...
                                <li><a href="#">مصالح ساختمانی عرض کامل<i class="arrow fa fa-angle-right"></i></a>
                                    <!--start level 3-->
                                    <ul>
                                ...
                                <li><a href="#">عنوان ساختمان<i class="arrow fa fa-angle-right"></i></a>
                                    <!--start level 3-->
                                    <ul>
                        ...
                        <li><a href="#"> فروشگاه <i class="fa fa-angle-down"></i><i class="arrow fa fa-angle-right"></i></a>
                            <!--start level 2-->
                            <ul>
                        ...
                        <li><a href="#"> پشتیبانی <i class="fa fa-angle-down"></i><i
                                        class="arrow fa fa-angle-right"></i></a>
                            <!--start level 2-->
                            <ul>
                                <li>
